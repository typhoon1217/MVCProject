...
//클라이언트!
	...
	public static void adminEmpMenuView() {
		...
		System.out.println("0. 뒤로|관리자 메뉴");
	...
	// 메뉴판 관리 메뉴
	public static void adminMenuManageView() {
		System.out.println();
		prBar();
		System.out.println("관리자 클라이언트");
	...
	// 주방 메뉴
	public static void cookMenuView() {
		System.out.println();
		prBar();
	...
	// 서빙 메뉴
	public static void tableMenuView() {
		System.out.println();
		prBar();
	...
	// 주문 메뉴
	public static void takeOrderMenuView() {
		System.out.println();
		prBar();
		System.out.println("서빙 클라이언트");
		...
		prBar();
		System.out.println("해당 번호를 입력하세요.");
		System.out.println("0. 테이블 메뉴로 돌아가기");
		System.out.println("1. 메뉴 보기");
		System.out.println("2. 주문 추가");
		System.out.println("3. 주문 제거");
		System.out.println("4. 주방 체크");
		System.out.println("5. 계산 받기");
